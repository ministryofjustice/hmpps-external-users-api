...
class UserGroupControllerIntTest : IntegrationTestBase() {
  ...
  inner class RemoveGroupByUserId {
    ...
    fun `remove group from user success`() {
      webTestClient
        .delete().uri("/user/id/7CA04ED7-8275-45B2-AFB4-4FF51432D1EC/groups/site_1_group_1")
    ...
    fun `remove group as group manager`() {
      webTestClient
        .delete().uri("/user/id/90F930E1-2195-4AFD-92CE-0EB5672DA02F/groups/SITE_1_GROUP_1")
    ...
    fun `does not remove group if group Manager not member of group`() {
      webTestClient
        .delete().uri("/user/id/90F930E1-2195-4AFD-92CE-0EB5672DA02C/groups/GC_DEL_4")
        .headers(setAuthorisation("AUTH_GROUP_MANAGER", listOf("ROLE_AUTH_GROUP_MANAGER")))
        .exchange()
    ...
    fun `does not remove group if group Manager and users last group`() {
      webTestClient
        .delete().uri("/user/id/90F930E1-2195-4AFD-92CE-0EB5672DA44B/groups/SITE_1_GROUP_1")
        .headers(setAuthorisation("AUTH_GROUP_MANAGER", listOf("ROLE_AUTH_GROUP_MANAGER")))
        .exchange()
