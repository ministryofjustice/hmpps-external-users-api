...
@Repository
interface RoleRepository : CoroutineCrudRepository<Authority, String>, ReactiveQueryByExampleExecutor<Authority> {
  @NonNull
  ...
  suspend fun findAll(role: Authority): Flow<Authority>
