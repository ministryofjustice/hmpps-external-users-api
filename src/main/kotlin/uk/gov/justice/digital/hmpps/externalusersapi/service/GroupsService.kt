...
import uk.gov.justice.digital.hmpps.externalusersapi.assembler.GroupDetailsAssembler
...
class GroupsService(
  ...
  private val groupDetailsAssembler: GroupDetailsAssembler
) {
  ...
  suspend fun getGroupDetail(groupCode: String): GroupDetails {
    ...
    return groupDetailsAssembler.assembleGroupDetail(groupCode)
  }
