...
VALUES ('C0279EE3-76BF-487F-833C-AA47C5DF22F8', 'CA_USER', 'ca_user@digital.justice.gov.uk', true, 'nomis'),
       ...
       ('89A9E5AA-12F4-4C3F-9B29-1F632B5B1889', 'IMS_ADMIN_LOCAL', 'ims_admin_local@digital.justice.gov.uk', true, 'nomis'),
       ('A7CA0B27-6235-444D-9586-E80CDAF462FB', 'IMS_READONLY_LOCAL', 'ims_readonly_local@digital.justice.gov.uk', true, 'nomis'),
       ('83A9E5AA-12F4-4C3F-9B29-1F632B5B1889', 'IMS_COLLATOR_LOCAL', 'ims_collator_local@digital.justice.gov.uk', true, 'nomis'),
       ('A9CA0B27-6235-444D-9586-E80CDAF462FB', 'IMS_ANALYST_LOCAL', 'ims_analyst_local@digital.justice.gov.uk', true, 'nomis'),
...
INSERT INTO user_role (role_id, user_id) SELECT role_id, user_id from roles, users where username = 'AUTH_IMS_USER2' and role_code = 'IMS_USER';
...
INSERT INTO user_group (group_id, user_id) SELECT group_id, user_id from groups, users where username = 'AUTH_GROUP_MANAGER' and group_code = 'SITE_1_GROUP_3';
